...
/********************************************************************/
$address_residence = $address_park;
var_dump($address_park);
var_dump($address_residence);
echo $address_residence == $address_park ? 'Are equal. <br>' : 'Are not equal <br>';
echo $address_residence === $address_park ? 'Are equal and of the same instances of the class. <br>' : 'Are not of the same instance. <br>';
echo $address_residence instanceof AddressPark ? 'Is an AddressPark <br>' : 'Is not an AddressPark but a ' . get_class($address_residence) . '<br>';