...
echo '<h2>Displaying constants</h2>';
echo '<tt><pre>' . var_export (Address::ADDRESS_TYPE_RESIDENCE, TRUE) . '</pre></tt>';
echo '<tt><pre>' . var_export (Address::ADDRESS_TYPE_BUSINESS, TRUE) . '</pre></tt>';
echo '<tt><pre>' . var_export (Address::ADDRESS_TYPE_PARK, TRUE) . '</pre></tt>';
